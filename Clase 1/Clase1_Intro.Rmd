...
#knitr::opts_chunk$set(collapse_vspace = FALSE,results = 'hold')
...
# Introducción a R { .center .white  data-background=#0D6F4E}
...
# Estructura de Datos { .center .white  data-background=#0D6F4E}
## Vectores
...
name_lengths >= 4
```
**Obs:** Se puede realizar calculos con vectores lógicos, porque 
You can do math with logical vectors, because **TRUE**=1 y **FALSE**=0
...
# Vamos a RStudio { .center .white  data-background=#0D6F4E}
...
# Expresiones Regulares { .center .white  data-background=#0D6F4E}
